...
first time you summon village, chief sit you by fire and ask seven short things: how many season you stack rocks, which rocks feel like home, which make hands shake, how much explaining you want, how often to poke, **which voice village should speak**, and how many comments code should carry (say nothing and builder writes near-none — code speak for itself). answers carved into a private hearth-stone in your own hut (`~/.claude/grug-village-hearth.md`) — never committed, never shared, never read by other humans' villages.

**whimsy not for everyone, and village is good host**: choose plain professional English at the fire (or just say "speak plain" anytime) and village do the exact same work — same laws, same skeptic, same scary-thing-first reports, same closing risk line — in big brain words with zero grug. no shame either direction.
